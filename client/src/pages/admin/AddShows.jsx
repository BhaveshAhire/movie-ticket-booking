...
const AddShows = () => {
  ...
  return nowPlayingMovies.length>0 ?(
    <>
      ...
      <div className='overflowx-x-auto pb-4'>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
          ...
          <input type="number" min={0} value={showPrice} onChange={(e)=>setShowPrice(e.target.value)} placeholder='Enter the show price' className='outline-none' />
        </div>
      </div>
      ...
      <div className='mt-6'>
        ...
        <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
          ...
          <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 text-sm rounded-l-lg hover:bg-primary cursor-pointer'>Add Time</button>
        </div>
      </div>
